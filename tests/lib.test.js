...
describe('registerUser', () => {
  ...
  it('should return a user object if valid username is passed', () => {
    const result = lib.registerUser('Josh');
    expect(result).toMatchObject({username: 'Josh'});
...
describe('notifyCustomer', () => {
  it('should send an email to the customer I.', () => {
    db.getCustomerSync = function(customerId) {
      return { email: 'a' };
    }
  ...
  it('should send an email to the customer II.', () => {
